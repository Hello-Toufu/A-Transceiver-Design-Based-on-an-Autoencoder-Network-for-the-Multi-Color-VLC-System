...
xi = 0.1
print("xi:", xi)
H_rgby = tf.constant([[0.363, 0.008, 0.001, 0.002], [0.024, 0.309, 0.014, 0.037], [0.001, 0.002, 0.425, 0.010], [0.003, 0.002, 0.030, 1.000]],
                dtype=tf.float32)
H_rgb = tf.constant([[1, 0.111, 0], [0, 0.941, 0], [0, 0, 0.738]],
                dtype=tf.float32)
# H = H_rgby
