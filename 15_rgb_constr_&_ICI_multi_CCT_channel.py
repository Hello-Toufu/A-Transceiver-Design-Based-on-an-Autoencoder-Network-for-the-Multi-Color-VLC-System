...
# change the channel matrix into a actual channel matrix which is estimated under the real vlc env
############################################################################
...
# SNR_train_dB_1 = 15
# SNR_train_dB_2 = 10
SNR_train_dB_1 = np.random.uniform(15,20,size=N_train)
...
xi = 0.1
print("xi:", xi)
H_rgby = tf.constant([[0.271, 0.030, 0, 0], [0, 0.255, 0.002, 0], [0, 0.003, 0.220, 0.007], [0, 0, 0.003, 0.200]],
                dtype=tf.float32)
H_rgb = tf.constant([[0.271, 0.030, 0], [0, 0.255, 0], [0, 0, 0.200]],
                dtype=tf.float32)
# H = H_rgby
...
x_old = np.array([0.169,0.734,0.402])
y_old = np.array([0.007,0.265,0.597])
...
for i_color in [0]:
    ...
    # AE config
    # ###########################################################
    autoencoder = Model(inputs=[input_signal,SNR_train_dB_train_input], outputs=[decoded1_s1, color_loss])
    ...
    autoencoder.fit([data1,SNR_train_dB_1], [data1, random_const],
                    epochs=epochs,
...
# print("\n")
# print("bler_5700K:", bler_5700K)
# print("color_loss_5700K:", color_loss_5700K)
# print("average_current_5700K:", average_current_5700K)
# print("\n")
print("bler_5000K:", bler_5000K)
...
print("\n")
# print("bler_4000K:", bler_4000K)
# print("color_loss_4000K:", color_loss_4000K)
# print("average_current_4000K:", average_current_4000K)
print("bler_2700K:", bler_2700K)
...
# plt.plot(SNR_range_dB, bler_5700K, 'yo-',
#          label='Autoencoder(' + str(n_channel) + ',' + str(k) + ')_s1')
plt.plot(SNR_range_dB, bler_5000K, 'go-',
         label='Autoencoder(' + str(n_channel) + ',' + str(k) + ')_s1')
# plt.plot(SNR_range_dB, bler_4000K, 'bo-',
#          label='Autoencoder(' + str(n_channel) + ',' + str(k) + ')_s1')
