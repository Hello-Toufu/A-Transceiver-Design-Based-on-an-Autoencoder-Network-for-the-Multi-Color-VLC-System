    ...
    for i_p_tx=1:length(SNR_dB)
        ...
        for mm = 1:num_loop
            ...
            for i_random_num = 1:random_symbol_num_per_color
                ...
                d0000 = norm(r-H*s(:,1 ))^2/(H_noise_std^2*norm(s(:,1 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,1 ))^2 + awgn_noise_std^2 );
                d0001 = norm(r-H*s(:,2 ))^2/(H_noise_std^2*norm(s(:,2 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,2 ))^2 + awgn_noise_std^2 );
                d0010 = norm(r-H*s(:,3 ))^2/(H_noise_std^2*norm(s(:,3 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,3 ))^2 + awgn_noise_std^2 );
                d0011 = norm(r-H*s(:,4 ))^2/(H_noise_std^2*norm(s(:,4 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,4 ))^2 + awgn_noise_std^2 );
                d0100 = norm(r-H*s(:,5 ))^2/(H_noise_std^2*norm(s(:,5 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,5 ))^2 + awgn_noise_std^2 );
                d0101 = norm(r-H*s(:,6 ))^2/(H_noise_std^2*norm(s(:,6 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,6 ))^2 + awgn_noise_std^2 );
                d0110 = norm(r-H*s(:,7 ))^2/(H_noise_std^2*norm(s(:,7 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,7 ))^2 + awgn_noise_std^2 );
                d0111 = norm(r-H*s(:,8 ))^2/(H_noise_std^2*norm(s(:,8 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,8 ))^2 + awgn_noise_std^2 );
                d1000 = norm(r-H*s(:,9 ))^2/(H_noise_std^2*norm(s(:,9 ))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,9 ))^2 + awgn_noise_std^2 );
                d1001 = norm(r-H*s(:,10))^2/(H_noise_std^2*norm(s(:,10))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,10))^2 + awgn_noise_std^2 ) ;
                d1010 = norm(r-H*s(:,11))^2/(H_noise_std^2*norm(s(:,11))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,11))^2 + awgn_noise_std^2 ) ;
                d1011 = norm(r-H*s(:,12))^2/(H_noise_std^2*norm(s(:,12))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,12))^2 + awgn_noise_std^2 ) ;
                d1100 = norm(r-H*s(:,13))^2/(H_noise_std^2*norm(s(:,13))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,13))^2 + awgn_noise_std^2 ) ;
                d1101 = norm(r-H*s(:,14))^2/(H_noise_std^2*norm(s(:,14))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,14))^2 + awgn_noise_std^2 ) ;
                d1110 = norm(r-H*s(:,15))^2/(H_noise_std^2*norm(s(:,15))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,15))^2 + awgn_noise_std^2 ) ;
                d1111 = norm(r-H*s(:,16))^2/(H_noise_std^2*norm(s(:,16))^2 + awgn_noise_std^2) + color_num*log( H_noise_std^2*norm(s(:,16))^2 + awgn_noise_std^2 ) ;
...
ylabel('BLER')
% save workspace
save('RGBY_same_h_constellation_design_vs_AE_multi_CSI_ML.mat')
