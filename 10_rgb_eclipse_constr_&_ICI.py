...
x_mixed_rgby = tf.math.divide(tf.reduce_sum(xc_divide_yc*I_mean/c,axis=0),tf.reduce_sum(yc_reciprocal*I_mean/c,axis=0))
y_mixed_rgby = tf.math.divide(tf.reduce_sum(I_mean/c,axis=0),tf.reduce_sum(yc_reciprocal*I_mean/c,axis=0))
