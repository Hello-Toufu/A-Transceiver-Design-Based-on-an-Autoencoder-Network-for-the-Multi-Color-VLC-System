...
# <font size=5>Multi-color VLC </font>
#
# ***SISO condition***
#
# * constraint: average power or fix power
# * n_channel/M for different communication rates
# * dynamic alpha loss
...
random_aveP = np.random.randn(N_train, )
random_aveP.shape
